 ...
 */
 ...
 var completePerson = buildPerson(plainPerson,"John D'oh", 69);
...
function printProcessedOrders(orders){
    for (var i=0; i<orders.length; i++){
        ...
        console.log("Purchased Date: " + orders[i].date);
        console.log("Purchased Total: " + orders[i].total);
        console.log("=====");
    }
}
